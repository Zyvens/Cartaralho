...
INSERT INTO market_catalog(product_key,name,description,category,product_kind,price,config,catalog_version,enabled,sort_order) VALUES
 ...
 ('cosmetic_frame_folhas','Coroa de Folhas','Folhas luminosas envolvem o avatar como um troféu vivo.','cosmetic','cosmetic_frame',125000,'{"cosmeticType":"frame","equipKey":"cosmetic-folhas","rarity":"legendary","icon":"🌿"}'::jsonb,'p14-frames-v1',true,380),

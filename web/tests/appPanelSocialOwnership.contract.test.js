...
test('AppPanelModal canônico preserva shell, cinco painéis e Perfil modal',()=>{
 ...
 assert.match(panel,/kind==='profile'\?ProfileModal\.open\('profile'\):PANEL_META\[kind\]\?AppPanelModal\.open\(kind\):baseOpen\(kind\)/);

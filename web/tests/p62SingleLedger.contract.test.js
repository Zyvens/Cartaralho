...
test('P62 permanece carregado e versionado após releases posteriores',()=>{
 assert.ok(index.indexOf('css/p62.css?v=1.4.71')>index.indexOf('css/p60.css?v=1.4.60'));
 assert.ok(index.indexOf('js/p62.js?v=1.4.71')>index.indexOf('js/p61.js?v=1.4.71'));

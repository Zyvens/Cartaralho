...
const css=read('public/css/p46.css'),index=read('public/index.html'),release=read('lib/releaseP46.js'),notifications=read('api/notifications.js');
...
test('P46 continua carregado e preservado no histórico de releases',()=>{

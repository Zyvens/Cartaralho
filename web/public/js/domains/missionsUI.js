...
(()=>{
 ...
 CartDomains.claim('missionsUI','domains/missionsUI.js',()=>{
  ...
  install();window.addEventListener('pageshow',closeStartup);window.CartMissionsDomain={missionRow,rewardBuff,closeStartup,install};
 });
})();

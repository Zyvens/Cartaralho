...
(()=>{
 ...
 const AccountActions={
  ...
  patch(){
   if(typeof HomeScreen==='undefined'||HomeScreen.__p56AccountActions)return;
 ...
 const Library={
  ...
  consolidate(){
   if(typeof ProfessionalUI!=='undefined')ProfessionalUI.renderCards=(panel,...args)=>Library.render(panel,...args);
   if(typeof HomeScreen!=='undefined')HomeScreen.renderCards=(panel,...args)=>Library.render(panel,...args);
   if(typeof MetaUI!=='undefined')MetaUI.renderCards=(panel,...args)=>Library.render(panel,...args);
  }
 };

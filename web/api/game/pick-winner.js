...
module.exports = withErrors(async (req, res) => {
  ...
  const { winnerNickname, winnerCard, gameOver } = gameManager.pickWinner(room, playerId, submissionIndex);

...
const{APP_VERSION,RELEASE}=require('../lib/releaseP41');
...
module.exports=withErrors(async(req,res)=>{
 ...
 const blocked=new Set([RELEASE.id,P40_RELEASE.id,P39_RELEASE.id,P38_RELEASE.id,P37_RELEASE.id]);
 data.updates=[RELEASE,P40_RELEASE,P39_RELEASE,P38_RELEASE,P37_RELEASE,...(data.updates||[]).filter(x=>!blocked.has(x.id))];
 ok(res,data);
});
